...
// Batsugun-local game instantiation. Derived from JTFrame's
// jtframe_game_instance.v so save-state ports can be added without modifying
// the shared framework include.
...
`endif
    ...
    // Batsugun save-state controller and state-bus slave.
    .ss_do_save       ( ss_save             ),
